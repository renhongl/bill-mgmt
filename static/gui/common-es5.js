(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppModulesUniversityUniversityServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let UniversityService = class UniversityService {
      ...
      deleteUni(id) {
        ...
        return this.http.delete("".concat(_utils_url__WEBPACK_IMPORTED_MODULE_3__["default"].UNIVERSITY, "/").concat(id), options);
      }
