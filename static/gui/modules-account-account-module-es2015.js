...
/* harmony import */ var _account_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./account.service */ "./src/app/modules/account/account.service.ts");
...
AccountModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(AccountRoutes),
...
let AccountService = class AccountService {
    ...
    getUser() {
        ...
        return this.http.get(`${_utils_url__WEBPACK_IMPORTED_MODULE_3__["default"].USER}/${id}`, options);
    }
    uploadFile(file, type) {
        ...
        return this.http.post(`${_utils_url__WEBPACK_IMPORTED_MODULE_3__["default"].FILE}/${type}`, formData, options);
    }
    updateAccount(user) {
        const id = JSON.parse(localStorage.getItem('bill-user'))._id;
        const postData = user;
        ...
        return this.http.put(`${_utils_url__WEBPACK_IMPORTED_MODULE_3__["default"].USER}/${id}`, postData, options);
    }
};
